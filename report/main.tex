...
\newpage % Ngắt trang để bắt đầu trang danh mục tổng hợp

% Bắt đầu nhóm lệnh gộp trang
\begingroup
\let\clearpage\relax % Vô hiệu hóa lệnh ngắt trang
\let\cleardoublepage\relax % Vô hiệu hóa ngắt trang đôi (nếu có)
    ...
    \vspace{2cm} % Khoảng cách giữa Danh mục hình và Danh mục bảng (Tùy chỉnh)
    ...
    \vspace{2cm} % Khoảng cách giữa Danh mục bảng và Thuật ngữ (Tùy chỉnh)
...
% Kết thúc nhóm lệnh, trả lại tính năng ngắt trang bình thường cho các chương sau
\endgroup 
\newpage
