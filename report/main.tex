...
\subfile{Chapter/2_Phan_tich_va_thiet_ke.tex}


\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{CÔNG NGHỆ SỬ DỤNG}
\subfile{Chapter/3_Cong_nghe_su_dung.tex}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{TÍNH NĂNG HỆ THỐNG}
\subfile{Chapter/4_Tinh_nang.tex}

\newpage
%\pagestyle{fancy} % Áp dụng header và footer
\chapter{TRIỂN KHAI HỆ THỐNG}
\subfile{Chapter/5_Trien_khai.tex}
