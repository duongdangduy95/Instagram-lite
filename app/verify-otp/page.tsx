    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md">
            ...
            {success ? (
              ...
              <>
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-300 text-sm mb-1">Chúng tôi đã gửi mã OTP gồm 6 chữ số đến</p>
          ...
          <p className="text-center text-gray-500 text-sm mt-8">Copyright © Instagram Lite</p>
        </div>
      </div>
    </div>
  )
...
// 3. Export default bọc trong Suspense để tránh lỗi build Vercel
export default function VerifyOTPPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gray-900 flex items-center justify-center text-white">
        <div className="animate-pulse">Đang tải trang xác thực...</div>
      </div>
    }>
      <VerifyOTPContent />
    </Suspense>
