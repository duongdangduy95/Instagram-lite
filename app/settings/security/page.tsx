  ...
  return (
    <div className="max-w-4xl mx-auto px-4 lg:px-8 py-8">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400 mt-2">Đảm bảo mật khẩu của bạn có ít nhất 6 ký tự.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-[#212227] border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all"
        ...
        <div className="flex items-center gap-3 mt-8">
          <button
            type="submit"
            disabled={isLoading}
            className="px-5 py-3 bg-[#877EFF] text-white rounded-lg hover:opacity-90 transition-opacity font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
          >
